...
/* THUMBS UP */
function setThumbsUp(x) {
    document.cookie = x + "=" + location.pathname + ";path=/;";
}
...
$("#thumbs_up > a").on("mouseover", function () {
    if (checkThumbs() == true) {
        $("#thumbs_up > a img")[0].src = "/Assets/Images/Sallie_Mae_Images/custom_functions/thumbs-up-active." + gifVsvg;
    }
});

$("#thumbs_up > a").on("mouseout", function () {
    if (checkThumbs() == true) {
        $("#thumbs_up > a img")[0].src = "/Assets/Images/Sallie_Mae_Images/custom_functions/thumbs-up." + gifVsvg;
    }
});

$("#thumbs_up > a").on("click toucstart", function () {
    if (checkThumbs() == true) {
        setThumbsUp("thumbs_up");
        $("#thumbs_up > a img")[0].src = "/Assets/Images/Sallie_Mae_Images/custom_functions/thumbs-up-active." + gifVsvg;
        trackThumb('Thumbs Up');
    }
});

$("#thumbs_down > a").on("mouseover", function () {
    if (checkThumbs() == true) {
        $("#thumbs_down > a img")[0].src = "/Assets/Images/Sallie_Mae_Images/custom_functions/thumbs-down-active." + gifVsvg;
    }
});

$("#thumbs_down > a").on("mouseout", function () {
    if (checkThumbs() == true) {
        $("#thumbs_down > a img")[0].src = "/Assets/Images/Sallie_Mae_Images/custom_functions/thumbs-down." + gifVsvg;
    }
});

$("#thumbs_down > a").on("click toucstart", function () {
    if (checkThumbs() == true) {
        setThumbsUp("thumbs_down");
        $("#thumbs_down > a img")[0].src = "/Assets/Images/Sallie_Mae_Images/custom_functions/thumbs-down-active." + gifVsvg;
        trackThumb('Thumbs Down');
    }
});

function thumbsUp() {
    if (document.cookie.indexOf("thumbs_up=" + location.pathname) != -1) {
        $("#thumbs_up > a img")[0].src = "/Assets/Images/Sallie_Mae_Images/custom_functions/thumbs-up-active." + gifVsvg;
    }
    if (document.cookie.indexOf("thumbs_down=" + location.pathname) != -1) {
        $("#thumbs_down > a img")[0].src = "/Assets/Images/Sallie_Mae_Images/custom_functions/thumbs-down-active." + gifVsvg;
    }
}

function checkThumbs() {
    if (document.cookie.indexOf("thumbs_up=" + location.pathname) != -1 || document.cookie.indexOf("thumbs_down=" + location.pathname) != -1) {
        return false;
    }
    else {
        return true;
...
function opinionLabLink() {
    window.open("https://secure.opinionlab.com/ccc01/o.asp?id=SsfeHLUH&referer=" + document.location.pathname);
}
